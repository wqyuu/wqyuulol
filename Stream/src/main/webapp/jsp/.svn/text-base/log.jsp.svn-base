...
<head>
    ...
    <script src="../jss/login.js" type="text/javascript" charset="utf-8"></script>
    <title>登陆</title>
</head>
<body>
    ...
    <div class="row">
        <div class="row bjys ztys dlkwz">
            <div class="col-xs-4">
                <h1 class="btys">登录</h1>
                <p>到现有的WePlay账户</p> <br>
                <form action="${pageContext.request.contextPath}/user/log.do" method="post">
                <p>用户名</p>
                <input type="text" class="form-control" placeholder="用户名" id="name" name="username">
                <h5>密码</h5>
               ...
               <!--  <button type="submit" class="btnys" onclick="login()"><p class="btys">登录</p></button> -->
                <p class="btys"><input  type="submit" value="登录" class="btnys"/></p>
                <br/><br/>
