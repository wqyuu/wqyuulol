    ...
    <div class="row">
        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            ...
            <div calss="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h3 style="color:white" id="gamename">捡垃圾</h3>
                    </div>
                </div>
                <!--游戏视频图片以及文字介绍-->
                <div class="row">
...
1111111111111111111111111111111111
                        ...
                        <div class="row addmargin">
                            <div class="col-md-1 btn_1" onClick="move('left')">
                                <span class="glyphicon glyphicon-chevron-left">1</span>
                            </div>
                            <div class="col-md-10 deletelrpadding" id="carousel_3">
                                <ul id="carousel_4"><li>2</li><li>2</li><li>2</li></ul>
                            </div>
                            <div class="col-md-1 btn_1" onClick="move('right')">
                                <span class="glyphicon glyphicon-chevron-right">3</span>
                            </div>
                        </div>
