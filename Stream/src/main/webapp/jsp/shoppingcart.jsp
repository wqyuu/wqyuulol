			...
			<div class="col-xs-10 col-sm-10 col-md-10">
				...
				<table style="color: #fbfbfb" class="table">
					<thead>
						...
						<tr>
							...
							<th width="15%"><a href="${pageContext.request.contextPath}/game/delete.do?id=${car.game.id}" 
							 onclick="javaScript:alert('别再因为游戏冷落了身边的人');"  >删除</a></th>
				...
				<div align="right" style="border-top-width: 10px; padding: 20px">
					<a class="btn btn-default btn-lg active"
						style="background-color: #090" href="../jsp/order_2.jsp" onclick="javaScript:alert('守护世界的任务还是交给我吧!'); ">确定购买</a>
