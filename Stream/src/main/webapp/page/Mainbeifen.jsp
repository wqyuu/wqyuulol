		...
		<div class="top">
			<div class="top-inner layout">
					...
					<div id="J_subNav" class="sub-nav">
						<ul class="sub-nav-inner">
							<li class="sub-nav-item"><a class="sub-nav-lnk"
								...
								href="page/skill" target="_blank"><i class="icon-hot"></i>资料库</a>
				...
				<div id="J_topUser" class="top-user">
					...
					<div id="LoginBox">
						<div class="row1">
							用户登录<a href="javascript:void(0)" title="关闭窗口"
								class="close_btn" id="closeBtn">×</a>
						</div>
						
						<form action="">
						<div class="row">
							账&nbsp;&nbsp;&nbsp;&nbsp;号: <span class="inputBox"> 
						...
						<div class="row">
							密&nbsp;&nbsp;&nbsp;&nbsp;码: <span class="inputBox"> <input	type="text" id="txtPwd" placeholder="密码" />
	...
	<div class="menu">
		<ul id="J_menu" class="menu-inner layout">
			...
			<li id="J_menuVideo" class="menu-item">视频中心<i
				class="icon-update"></i></li>
			<li class="dot"></li>
			<li id="J_menuHMatch" class="menu-item">赛事中心<i
				class="icon-update"></i></li>
			<li class="dot"></li>
