    ...
    <div class="layout mainer">
		...
		<div class="colbox">
			...
			<div class="clearfix info-showbox">
				<ul id="spellList" class="imgtextlist spell-list"><p class="loading">召唤师技能加载中...</p></ul>
				<div id="spellDefail" class="spell-defail"><p class="loading">召唤师技能加载中...</p></div>
...
loadScript("http://localhost:8080/Stream/js/jineng.js",showSummonerFun);//   "脚本路径.js"，回调函数
</script>
</body>
</html><!--[if !IE]>|xGv00|a9ad933cecfab02034aa9d8b37aca836<![endif]-->