    ...
    <div class="layout mainer">
		...
		<div class="colbox">
			<div id="pageTAB" class="pagetab">
				<ul class="pagetab-list pagetab-list5">
			...
			<!-- 天赋列表 -->
			<div class="clearfix talentpage">
				<iframe frameborder="0" scrolling="no" allowtransparency="true" marginheight="0" marginwidth="0" src="http://lol.178.com/mnq/iframe/" style="width:100%; height:655px;"></iframe>
			</div>
			<!-- end 天赋列表 -->
		</div>
...
</html><!--[if !IE]>|xGv00|5b7e0647b6f3e4b4b4ceb63979ac8d9c<![endif]-->