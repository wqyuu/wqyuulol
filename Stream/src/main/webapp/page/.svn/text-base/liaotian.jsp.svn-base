...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath }/cs/bootstrap.min.css">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div id="msg" class="panel-body" style="height: 300px;">
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket("http://localhost:8080/Stream/websocket");
    }
    else {
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js1/Globals.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js1/websocket.js"></script>
</html>
