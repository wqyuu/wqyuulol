...
<div id="header" class="header">
    ...
    <div class="menu">
        <ul id="J_menu" class="menu-inner layout">
            ...
            <li class="dot"></li>
            <li id="J_menuHMatch" class="menu-item cur">赛事中心<i class="icon-update"></i></li>
            <li class="dot"></li>
                        ...
                        <div class="match-cont clearfix">
                            ...
                            <div class="match-strongest">
                                ...
                                <ul class="clearfix" id="the_best_players">
                                    <li>
                                        <img src="//ossweb-img.qq.com/images/lpl/web201612/power/ZQZL_1_Rookie.png" width="173" height="173">
                                        <i>
                                    ...
                                    <li>
                                        <img src="//ossweb-img.qq.com/images/lpl/web201612/power/zqzl_2_Vasilii.png" width="173" height="173">
                                        <i>
                                    ...
                                    <li>
                                        <img src="//ossweb-img.qq.com/images/lpl/web201612/power/zqzl_3_Scout.png" width="173" height="173">
                                        <i>
                                    ...
                                    <li>
                                        <img src="//ossweb-img.qq.com/images/lpl/web201612/power/zqzl_4_Mystic.png" width="173" height="173">
                                        <i>
                                    ...
                                    <li>
                                        <img src="//ossweb-img.qq.com/images/lpl/web201612/power/zqzl_5_Icon.png" width="173" height="173">
                                        <i>
                            ...
                            <div class="match-integral">
                                ...
                                <ul style="display:;" id="team_score_bar">
                                        <li class="fl"><a href="javascript:matchLoad.InitS7TeamScore(1);" class="on" rel=0>入围赛</a></li>
                                        <li class="fl"><a href="javascript:matchLoad.InitS7TeamScore(2);" rel=1>小组赛</a></li>
                                </ul>
                                <div class="match-rank match-world-rank clearfix" id="group_bar">
					<!-- JS插入 -->
				</div>
                                <div class="match-integral-box match-world-integral-box">
                                    <div class="match-group-box">
                                        ...
                                        <div class="match-group-table">
                                            <table class="match-rank-list" id="team_score_board_A" style="display: none;"><!-- JS插入 --></table>
                                            <table class="match-rank-list" id="team_score_board_B" style="display: none;"><!-- JS插入 --></table>
                                            <table class="match-rank-list" id="team_score_board_C" style="display: none;"><!-- JS插入 --></table>
                                            <table class="match-rank-list" id="team_score_board_D" style="display: none;"><!-- JS插入 --></table>
<table class="match-rank-list" id="team_score_board_E" style="display: none;"><!-- JS插入 --></table>
<table class="match-rank-list" id="team_score_board_F" style="display: none;"><!-- JS插入 --></table>
<table class="match-rank-list" id="team_score_board_G" style="display: none;"><!-- JS插入 --></table>
<table class="match-rank-list" id="team_score_board_H" style="display: none;"><!-- JS插入 --></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
</html><!--[if !IE]>|xGv00|c9b3275671ee0b2983dd149c558ce466<![endif]-->