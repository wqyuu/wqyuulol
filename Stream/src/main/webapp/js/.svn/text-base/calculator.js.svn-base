...
function masteryButtonPosition(tree, index) {
    ...
    if(tree==0){
        if(index==2||index==7||index==12){x=44;}
        if(index==3||index==8||index==13){x=111;}
        if(index==4||index==9||index==14){x=178;}
        if(index==0||index==5||index==10){x=79;}
        if(index==1||index==6||index==11){x=146;}
    }
    if(tree==1){
    	if(index==2||index==7||index==12){x=320;}
    	if(index==3||index==8||index==13){x=387;}
    	if(index==4||index==9||index==14){x=454;}
        if(index==0||index==5||index==10){x=355;}
        if(index==1||index==6||index==11){x=422;}
    }
    if(tree==2){
    	if(index==2||index==7||index==12){x=596;}
    	if(index==3||index==8||index==13){x=663;}
    	if(index==4||index==9||index==14){x=730;}
        if(index==0||index==5||index==10){x=631;}
        if(index==1||index==6||index==11){x=698;}
    }
// if(index==2&&tree==1)
// if(index==3&&tree==1){x=387;}
// if(index==4&&tree==1){x=454;}
// if(index==2&&tree==0){x=44;}
// if(index==3&&tree==0){x=111;}
// if(index==4&&tree==0){x=178;}
// if(index==2&&tree==2){x=596;}
// if(index==3&&tree==2){x=663;}
// if(index==4&&tree==2){x=730;}
    return {x: x, y: y};
}
