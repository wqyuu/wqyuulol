...
<![endif]-->
		...
		<div class="layout mainer">
			...
			<div id="jPersonBody" class="colbox pageuserbody" style="">
				<div class="clearfix">
					...
					<li id="jPersonTab2" class="current"><a href="${pageContext.request.contextPath }/userInfo/history.jsp" class="pagetab-list-lnk" onclick="pgvSendClick()">历史战绩</a></li>
				...
				<div id="jPersonDiv1" class="clearfix info-showbox"
					...
					<div class="perleftcont">
						...
						<div class="clearfix myhis">
							...
							<div id="jIndexBattleDetail" class="myhis-list"></div>
						</div>
					</div>
				...
				<!-- 比赛历史 -->
				<div id="jPersonDiv2" class="info-showbox" style="display: block;">
					<ul id="jGameDate" class="normal-tab">
						<li id="GameDate2017_10_15"
							onclick="LW201310_Battle.changeGameDate();" class=""><span
							class="nr">2017/10</span></li>
						<li id="GameDate2017_9_15"
							onclick="LW201310_Battle.changeGameDate();" class="current"><span
							class="nr">2017/9</span></li>
						<li id="GameDate2017_8_15"
							onclick="LW201310_Battle.changeGameDate();" class=""><span
							class="nr">2017/8</span></li>
					</ul>
					<div class="pagetab myhis-tab">
						<ul id="jPersonBattleList" class="pagetab-list pagetablist-five">
							<li class="Gid1696682123 current"><a
								href="javascript:LW201310_Battle.loadGame(&#39;1696682123&#39;,&#39;5&#39;,&#39;2017/09/23 18:13&#39;);"
								class="pagetab-list-lnk"><div class="smallmod">
										<img width="40" height="40" alt=""
											src="../images/Vayne.png">
										<p>
							...
							<li class="Gid1696599786"><a
								href="javascript:LW201310_Battle.loadGame(&#39;1696599786&#39;,&#39;5&#39;,&#39;2017/09/23 17:34&#39;);"
								class="pagetab-list-lnk"><div class="smallmod">
										<img width="40" height="40" alt=""
											src="../images/Karma.png">
										<p>
							...
							<li class="Gid1696580237"><a
								href="javascript:LW201310_Battle.loadGame(&#39;1696580237&#39;,&#39;5&#39;,&#39;2017/09/23 16:59&#39;);"
								class="pagetab-list-lnk"><div class="smallmod">
										<img width="40" height="40" alt=""
											src="../images/Teemo.png">
										<p>
							...
							<li class="Gid1696483949"><a
								href="javascript:LW201310_Battle.loadGame(&#39;1696483949&#39;,&#39;5&#39;,&#39;2017/09/23 12:04&#39;);"
								class="pagetab-list-lnk"><div class="smallmod">
										<img width="40" height="40" alt=""
											src="../images/Gnar.png">
										<p>
											<span class="cgreen cresult">胜利</span>&nbsp;<em>4杀2死1助攻</em>
										</p>
										<p class="carea">排位赛 召唤师峡谷</p>
										<p class="cdate">2017/09/23 12:04</p>
									</div></a></li>
							<li class="Gid1696463119"><a
								href="javascript:LW201310_Battle.loadGame(&#39;1696463119&#39;,&#39;5&#39;,&#39;2017/09/23 11:27&#39;);"
								class="pagetab-list-lnk"><div class="smallmod">
										<img width="40" height="40" alt=""
											src="../images/Gnar.png">
										<p>
											<span class="cgreen cresult">胜利</span>&nbsp;<em>12杀3死12助攻</em>
										</p>
										<p class="carea">排位赛 召唤师峡谷</p>
										<p class="cdate">2017/09/23 11:27</p>
									</div></a></li>
						</ul>
					</div>
					<div id="jPersonBattleDetail" class="myhis-list myhis-list-long">
						...
						<ul class="clearfix">
							<li class="myhis-list-item"><img width="26" height="26"
								alt="" src="../images/Teemo.png" class="">
							<p class="name">
									<a
								...
								<ul class="myitem">
									...
									<li><img data-title="3089"
										src="../images/3089.png" width="24" height="24"
										class=""></li>
							...
							<p class="name">
								...
								<ul class="myitem">
									...
									<li><img data-title="1052"
										src="../images/1052.png" width="24" height="24"
										class=""></li>
									<li><img data-title="1058"
										src="../images/1058.png" width="24" height="24"
										class=""></li>
									<li><img data-title="3340"
										src="../images/3340.png" width="24" height="24"></li>
								</ul></li>
							...
							<p class="name">
								...
								<ul class="myitem">
									...
									<li><img data-title="3340"
										src="../images/3340.png" width="24" height="24"
										class=""></li>
								</ul></li>
							<li class="myhis-list-item"><img width="26" height="26"
					...
					<div class="pages">
						<a id="jPrevPage"
							...
							class="pagenext" style="display: inline-block;">下一页</a>
				...
				<div id="jPersonDiv4" class="clearfix info-showbox"
					...
					<div id="jPersonTierDetail6" class="season4"
						...
						<div class="fl ranks-logo">
							<img width="135" src="../images/silver-logo.png"
								alt="不屈白银">
							<p class="cred">不屈白银</p>
						</div>
	...
	<div id="popPupItem" class="poppup-item"
		...
		<div id="itemFromTree" class="item-from">
			...
			<div class="clearfix item-tree item-depth2">
				<div class="tree-lv">
					<img src="../images/3089.png" alt="灭世者的死亡之帽"
						title="灭世者的死亡之帽"><i class="line1"></i>
				</div>
				<div class="tree-lv" style="width:100%">
					<i class="line0" style="width:66.66666666666667%"></i>
					<ul>
						<li class="tree-count3"><i class="line2"></i><img
							src="http://ossweb-img.qq.com/images/lol/img/item/1026.png"
	...
	<!--  end -->
	<!-- <script src="./个人资料-历史战绩_files/ue"></script>
 -->
	<script>
	...
	<div style="height: 0px; overflow: hidden;">
		<object id="storage" data="./个人资料-历史战绩_files/ajaxcdr.swf"
	...
	<div id="qb-sougou-search" style="display: none; opacity: 0;">
		...
		<iframe src="./个人资料-历史战绩_files/saved_resource.html"></iframe>
	</div>
</body>
</html>