...
style  type ="text/css">#header {
	height: 840px;
	overflow: hidden;
	background: url(../images/pic-big-v13.jpg) no-repeat center 90px;
...
#header-close {
	height: 440px;
	background: url(../images/pic-back-v13.jpg) no-repeat center
		90px
}
		...
		<div class="layout mainer">
			...
			<div id="jPersonBody" class="colbox pageuserbody" style="">
				<div class="clearfix">
					...
					<li id="jPersonTab4" class="current"><a href="${pageContext.request.contextPath }/userInfo/rongyu.jsp" class="pagetab-list-lnk" onclick="pgvSendClick()">个人荣誉</a></li>
				...
				<!-- 段位荣誉 -->
				<div id="jPersonDiv4" class="clearfix info-showbox" style="">
					...
					<div id="jPersonTierDetail5" class="season4" style="display: none;"></div>
...
milo.ready(function(){
	...
	<div style="height: 0px; overflow: hidden;">
		<object id="storage" data="../images/ajaxcdr.swf"
			type="application/x-shockwave-flash" height="0" width="0">
			<param name="movie"
				value="/comm-htdocs/js/milo/ajaxcdr.swf?0.3246735858872598">
