...
public class MailUtil {
	public static String myEmailAccount = "2549067835@qq.com";
	public static String myEmailPassword = "xvayyqxrqmvqdjie";
	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
	public static String myEmailSMTPHost = "smtp.qq.com";//"127.0.0.1";

	// 收件人邮箱（替换为自己知道的有效邮箱）
	 public static String receiveMailAccount = "2549067835@qq.com";
